...
They proposed the Immersive Robot Teleoperation Based on User Gestures in Mixed Reality Space (IRT-MRO) \cite{Esaki}.  
...
Each task was repeated approximately ten times.
...
the final executed base pose $\mathbf{b}^{*}$yields at least one feasible IK
