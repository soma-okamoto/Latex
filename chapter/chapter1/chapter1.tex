...
and follow it under velocity saturation in the robot frame (current pose from the
$\texttt{map}\!\to\!\texttt{base\_link}$ TF).
...
% \twoimgs[H]
%   {.48\linewidth}{BRI_ex2.pdf}{Phase1}{fig:Phase1}
%   {.48\linewidth}{BRI_ex3.pdf}{Phase2}{fig:Phase2}
% \figcaption{Sequential pick-and-place Phase1/Phase2}\label{fig:seqs}
...
number of regrasp attempts. Under these conditions, a comparative 
