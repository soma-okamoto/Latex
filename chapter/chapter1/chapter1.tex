...
Therefore, as illustrated in Figure\ref{fig:6}, 
...
\fig[H]{width = 0.5\linewidth}{Sample.pdf}{Figure6}{fig:6}
...
This mechanism realizes the coexistence of autonomous planning and user interaction, as depicted in Figure\ref{fig:8}.
% insert paired figures
\fig[H]{width = 0.5\linewidth}{Sample.pdf}{Figure8}{fig:8}



\paragraph{Case: Unknown path}:  
...
% insert paired figures
\fig[H]{width = 0.5\linewidth}{Sample.pdf}{Figure4}{fig:9}
...
\fig[H]{width = 0.5\linewidth}{Calib-6.pdf}{Figure4}{fig:IRM}
